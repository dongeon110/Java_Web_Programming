	...
	<body>
		...
		<form action='update.do' method='post'>
			...
			<ul>
				...
				<input id="no"
				type='text' name='no' size='10' value='${project.no}' readonly></li>
				...
				<input id="sdate"
				type='text' name='startDate' placeholder="예)2022-09-13" value='${project.startDate}'></li>
				
				<li><label for="edate">종료일</label>
				<input id="edate"
				type='text' name='endDate' placeholder="예)2022-09-13" value='${project.endDate}'></li>
				...
				<input id="tags"
				type='text' name='tags' placeholder="예)태그1 태그2 태그3" size="50" value='${project.tags}'></li>
			</ul>
