...
//			applicationContext = new ApplicationContext(propertiesPath);
			...
			applicationContext.prepareObjectsByProperties(propertiesPath); // 프로퍼티 파일의 내용에 따라 객체 생성
			applicationContext.prepareObjectsByAnnotation(""); // @Component Annotation붙은 클래스 찾아 객체 생성
			applicationContext.injectDependency(); // 의존 객체 주입
